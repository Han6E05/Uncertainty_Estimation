...
class YOLONASMCPredictor:
    ...
    def _display_comprehensive_uncertainty(self, image_path: str, result: Dict[str, Any], output_path: str):
        ...
        kp_uncertainty = result['keypoint_uncertainty']['overall_uncertainty']
        ...
        info_lines = [
            ...
            f"Global Unc: {global_uncertainty:.3f}",
            f"BBox Unc: {bbox_uncertainty:.3f}",
            f"Keypoint Unc: {kp_uncertainty:.3f}",
            f"Valid Passes: {result['num_valid_passes']}"
        ]
...
def comprehensive_uncertainty_demo_yolonas(image_path):
...
if __name__ == "__main__":
    ...
    for image_path in val_images:
        ...
        is_safe = comprehensive_uncertainty_demo_yolonas(image_path)
        total_count += 1
